#!/usr/bin/env python3
"""
DRUNetv2 ONNX Runtime Inference for Jetson Nano
================================================
...
Usage:
    ...
    python run_inference.py --model drunetv2_jetson.onnx --data test_data --output results
"""
...
# ========================  MAIN  ========================
def main():
    parser = argparse.ArgumentParser(description="DRUNetv2 ONNX inference")
    parser.add_argument("--model", default="drunetv2_jetson.onnx")
    ...
    print("\n" + "=" * 70)
    print("  DRUNetv2 ONNX Runtime Inference — Jetson Nano")
    print("=" * 70)
