#!/usr/bin/env python3
"""
DRUNetv2 TensorRT Inference for Jetson Nano 4 GB
=================================================
...
Usage (on Jetson Nano):
    ...
    python run_inference_trt.py --engine drunetv2_jetson_fp16.trt

    # FP32 engine:
    python run_inference_trt.py --engine drunetv2_jetson_fp32.trt
"""
...
# ========================  MAIN  ========================
def main():
    parser = argparse.ArgumentParser(description="DRUNetv2 TRT inference on Jetson Nano")
    parser.add_argument("--engine", type=str, default="drunetv2_jetson_fp16.trt",
    ...
    print()
    print("=" * 70)
    print("  DRUNetv2 TensorRT Inference  —  Jetson Nano 4 GB")
    print("=" * 70)
